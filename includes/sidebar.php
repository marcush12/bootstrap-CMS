<aside class="col-lg-4">
    <form action="" class="panel-group form-horizontal" action="search.php" role="form">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" id="username" name="user_name" class="form-control" placeholder="Insert your email">
                    </div>
                </div>
                <div class="form-group">
